                ...
                >
                  ...
                  <div className="flex gap-2">
                    <button
                      ...
                      className="flex-1 rounded-md bg-[--gold] text-white px-4 py-2 text-sm font-medium hover:brightness-95 transition disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-1.5"
